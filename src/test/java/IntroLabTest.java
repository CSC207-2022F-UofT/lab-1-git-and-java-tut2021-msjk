...
public class IntroLabTest {
     ...
     */
    @Test(timeout = 100)
    public void testTangju10() {
        String expected = "Good afternoon! My name is Julie Tang! " +
                "I like cats more than dogs! First CSC207 tutorial!";
        String actual = IntroLab.tangju10();
        assertEquals(expected, actual);
    }
}
